...
ㅛ<img width="952" height="1011" alt="image" src="https://github.com/user-attachments/assets/7d893666-118f-40bc-8d58-f70a2ffd0220" />
...
<img width="952" height="1000" alt="image" src="https://github.com/user-attachments/assets/d134203c-ac45-46de-a6b5-c587b566baac" />
...
<img width="951" height="996" alt="image" src="https://github.com/user-attachments/assets/c1f29f8a-ef65-4614-bfa8-9755b39bae68" />
...
<img width="982" height="413" alt="image" src="https://github.com/user-attachments/assets/5874b44f-e5ba-408f-af13-07b015b18ad5" />
...
- 자료구조, 알고리즘 잔술 데이터를 다루는 대부분의 과학 계산 애플리케이션에서 필요한 라이브러리 제공
- 산술계산 위주
B. 판다스 PANDAS
- 구조화된 데이터나 표 형식의 데이터를 직관적이고 유연하게
- 주된 자료구조: 행과 열 이름 가지는 dataframe/series
- 넘파이 고성능 + SQL 같은 관계형 데이터베이스의 데이터 처리 기능
- 시계열, 누락 데이터 처리, 관계 연산 등
C.맷플롯립 MAtplotlob
- 그래프나 2차원 데이터 시각화 생성
-기본 시각화 도구
D. IPYTHON과 주피터
- 많은 프로그래밍 언어으 ㅣ특징인 편집 - 컴파일 - 실행 방식 대신 실행 - 탐색 방식 장려해 파일 시스템과 운영체제 셸에서도 쉽게 접근 가능
E. 사이파이 SCIPY
- 과학 계산 영역의 여러  기본 문제 다룸
- scipy.integrate
- scipy.linalg 등등
F. 사잇킷런 SCKIT-LEARN
- 분류, 회귀, 클러스터링, 차원 축소, 모델 선택, 전처리 등 범용 머신러닝 도구 
---
...
<img width="690" height="342" alt="image" src="https://github.com/user-attachments/assets/b5982d7e-da96-45f4-8e43-60994f99d8fa" />
